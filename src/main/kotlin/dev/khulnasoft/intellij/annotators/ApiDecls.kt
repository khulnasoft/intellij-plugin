package dev.khulnasoft.intellij.annotators
...
class ApiDecls : Annotator {
    override fun annotate(element: PsiElement, holder: AnnotationHolder) {
        // If it's not a comment and doesn't start with "//khulnasoft:", return
        ...
        // Highlight the "//khulnasoft:" part of the comment as a comment keyword
